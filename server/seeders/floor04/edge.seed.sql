...
WITH raw_connections(c1, c2) AS (
  ...
  SELECT 'WP-F4-18', 'SECU-F4'  UNION ALL

  SELECT 'WP-F4-04', 'EL-EDI-F4' UNION ALL
  SELECT 'WP-F4-22', 'EL-EDI-F4' UNION ALL
  ...
  SELECT 'WP-F4-04', 'WP-F4-18'  UNION ALL
  SELECT 'WP-F4-18', 'WP-F4-19'  UNION ALL
  SELECT 'WP-F4-19', 'WP-F4-20'  UNION ALL
  SELECT 'WP-F4-20', 'WP-F4-21'  UNION ALL

  SELECT 'WP-F4-21', 'R-316-F4'  UNION ALL
  SELECT 'WP-F4-20', 'R-317-F4'  UNION ALL
  SELECT 'WP-F4-19', 'R-318-F4'  UNION ALL

  SELECT 'WP-F4-21', 'ST-L1-UP-F5' UNION ALL
  SELECT 'WP-F4-21', 'ST-L2-DOWN-F3' UNION ALL

  /* --- Derecha Edificio (Oficinas y Escaleras) --- */
  SELECT 'WP-F4-04', 'WP-F4-22'  UNION ALL
  SELECT 'WP-F4-22', 'WP-F4-23'  UNION ALL
  SELECT 'WP-F4-23', 'WP-F4-24'  UNION ALL
  SELECT 'WP-F4-24', 'WP-F4-25'  UNION ALL
